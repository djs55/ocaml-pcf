...
(* OASIS_START *)
(* DO NOT EDIT (digest: 912b806964ac3fe44c8e0afcc688f736) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "pcf"; FindlibPackage ("unix", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\247`\143!+\001\245>e\\\225\153\158\151\138\248";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
